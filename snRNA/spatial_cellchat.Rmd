...
pdf(paste0(fig_dir, 'cellchat_information_flow_comparison2.pdf'), width=5, height=10)
gg1
dev.off()
...
TODO: Run Part IV Systems analysis of cell-cell communication
https://htmlpreview.github.io/?https://github.com/sqjin/CellChat/blob/master/tutorial/CellChat-vignette.html#identify-signaling-roles-e.g.-dominant-senders-receivers-of-cell-groups-as-well-as-the-major-contributing-signaling
```{r eval=FALSE}
